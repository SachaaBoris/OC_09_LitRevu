...
const radiosDiv = document.querySelector('.radioboutons-ontop');
const defaultValue = parseInt(radiosDiv.dataset.rating, 10);
...
const numberOfRadios = radios.length;
console.log("Number of radio buttons:", numberOfRadios);
